...
class FiberCamera(QWidget):
    ...
    def __init__(self, target_diameter: QDoubleSpinBox, gui: 'UserInterface') -> None: #new check
        ...
        self.canny_image = QLabel() #Created Canny live feed       
    ...
    def camera_loop(self) -> None:
        ...
        #Display Canny
        image_for_gui = QImage(edges, edges.shape[1],
                               edges.shape[0], QImage.Format_Grayscale8)
    ...
    def calibrate(self):
        ...
        print(f"Average width of wire: {average_diameter} ") 
        
        self.diameter_coefficient = 1.20/average_diameter #new check
        
        print(f"Diameter_coeff: {self.diameter_coefficient} mm/px")
